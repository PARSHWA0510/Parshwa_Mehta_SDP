...
void main(List<String> arguments) {
  ...
  */
  ...
  /*
  //For-each loops
  const myNumbers = [1, 2, 3];//creating list by using [] and coma separated elements.
  ...
  */
  ...
  /*
      ...
      //Here lastname variable only accessible inside if block bcz it is declared with const keyword.
      //so we can not accessible outside the if or else if block.
      const firstName = 'Parshwa';
      if (firstName == 'Dhara') {
        const lastName = 'Mehta';
      } else if (firstName == 'Parshwa') {
