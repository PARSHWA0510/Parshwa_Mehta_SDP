...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'Dh',
    'ara'
  ]; //This is same as , final desserts = const['Parshwa','Dh','ara'];
  ...
  */
  ...
  const pastries = ['red velvet', 'Black forest?'];
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'Parshwa');
  User user2 = User(2, 'Mehta');
  User user3 = User(3, 'Dhara');
