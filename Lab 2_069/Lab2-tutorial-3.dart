void main() {
  /*
        ...
        //casting down
        num someNumber = 3;
        print(someNumber.isEven); // errror : The getter 'isEven' isn't defined for the type 'num'.
  ...
  */
  ...
  /*
        ...
        const name = ‘Parshwa';
        message += name; // 'Hello my name is Parshwa'

        final message = StringBuffer();
        message.write('Hello');
        message.write(' my name is ');
        message.write('Parshwa');
        message.toString(); // "Hello my name is Parshwa"
  ...
  */
  ...
  /*
        ...
        print(bigString); //You can have a string
                          ...
                          //by
                          //doing this.
        //The three single-quotes (''') signify that this is a multi-linestring. Three double-quotes (""") would have done
        //the same thing.
        ...
        //sometimes you want to ignore any special characters that a string might contain. To do that, you can create a by
        //putting r in front of the string literal.
  ...
  */
  ...
  /*
        //Mini-Exercises
          ...
          //3.
          const myDetail = " Hello , My name is $fullName";//Hello , My name is Parshwa Mehta
  */
  ...
  /*
        ...
        var myVariable = 42;
        myVariable = "hello"; // valid in javascript but not in dart
  ...
  */
  ...
  /*
        ...
        //2.
        const name = 'Parshwa';
        name += ' Mehta'; // we can not change string content , it is immutable
