...
void main() {
  ...
  */
  ...
  //STATEMENTS
   ...
   //if condition is true then execute the statements in code block.
   if(true)
   {
     //code block
     print("The condition is true that's why this line is printed.");
   }
  */
  ...
  */
  ...
  //If you actually want to perform integer division,then you could use the ~/ operator:
  ...
  */
  ...
  //There’s no need to tell Dart that 10 is an integer.Dart makes someNumber an int. Type safety still applies, though:
    var someNumber = 10;
    someNumber = 15;
  //Trying to set someNumber to a double will result in an error. Your program won’t even compile. This means compiler is smart
  //enough to understand the datatype
    someNumber = 3.14159;
  */
  ...
  */
  ...
  Always try to choose meaningful names for your variables and constants. Good names act as documentation and make your code
   //easy to read.
  ...
  */
  ...
  // 3. Create a constant called testNumber and initialize it with whatever integer you’d like. Next, create another constant
  // called evenOdd and set it equal to testNumber modulo 2. Now change testNumber to various numbers. What do you notice about
  // evenOdd?
