...
void main(List<String> arguments) {
  ...
  */
  ...
  /*
  //Exercise:
  //1.Create a constant called myAge and set it to your age.Then, create a constant named isTeenager that usesBoolean logic to
  //determine if the age denotes someone in the age range of 13 to 19.
  ...
  //2. Create another constant named maryAge and set it to 30.Then, create a constant named bothTeenagers that uses Boolean
  //logic to determine if both you and Mary are teenagers.
  ...
  //3. Create a String constant named reader and set it to your name. Create another String constant named var and set it to
   'Dhara Mehta'. Create a Boolean constant named varReads uses string equality to determine if reader and var are
    equal.

  //False because strings are unequal
  const reader = "Parshwa Mehta";
  const var = "Dhar Mehta";
  const varReads = (reader == var);
  print(varReads);
  */


  /*
  //Strings are unequal so else block is executed
  const animal = 'Fox';
  ...
  //'INVALID COLOR' will be output as else block will be executed, because 'white' does not match any is block
